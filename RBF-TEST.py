...
file_to_read = "Data/from_center.csv"  # Which file to read
...
# Set linear kernel
rbf = RBFInterpolator(np.column_stack((x, y)), z, kernel='linear')  # Using linear kernel with epsilon lower = more spread
...
ax.set_title('RBF Interpolation with Kernel: Gaussian')
